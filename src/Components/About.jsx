    ...
    return <div id="about">
        <div className="flex flex-col justify-center gap-10 items-center mt-8 md:flex-row md:justify-between">
            ...
            <div className="sm:mr-20 mr-8 sm:pl-0 pl-12 sm:w-[60%]">
                ...
                <a href="https://drive.google.com/file/d/1wYZRJm8XOIYCH9e7_N-zzqsQ6d-bKoeQ/view?usp=sharing" target="blank"><button className="btn px-2 py-2 bg-orange-400 text-white hover:bg-orange-200 rounded">Dowload CV</button></a>
